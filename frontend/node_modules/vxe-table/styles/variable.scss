...
$vxe-input-date-title-height-default: 34px !default;
...
$vxe-input-date-time-week-row-height-default: 42px !default;
...
$vxe-input-date-month-year-row-height-default: 52px !default;
...
$vxe-input-date-quarter-row-height-default: 64px !default;
