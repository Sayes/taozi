...
--
-- Table structure for table `stats_result_1000`
--

DROP TABLE IF EXISTS `stats_result_1000`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stats_result_1000` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `project_id` varchar(50) DEFAULT NULL COMMENT '项目编码',
  ...
  `district` varchar(100) DEFAULT NULL COMMENT '政区名称',
  `maintain` varchar(100) DEFAULT NULL,
  `road_grade` varchar(5) DEFAULT NULL COMMENT '技术等级',
  `pavement_type` varchar(5) DEFAULT NULL COMMENT '路面类型',
  `pavement_width` decimal(10,2) DEFAULT NULL COMMENT '有效路面宽度',
...
-- Dump completed on 2022-05-29 10:44:31
