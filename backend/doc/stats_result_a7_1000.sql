...
--
-- Table structure for table `stats_result_a7_1000`
--

DROP TABLE IF EXISTS `stats_result_a7_1000`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stats_result_a7_1000` (
...
-- Dump completed on 2022-05-29 12:08:47
