package com.taozi.common.modules.redis.writer;
 ...
 */
@Slf4j
public class TaoziRedisCacheWriter implements RedisCacheWriter {

    private final RedisConnectionFactory connectionFactory;
    private final Duration sleepTime;

    public TaoziRedisCacheWriter(RedisConnectionFactory connectionFactory) {
        this(connectionFactory, Duration.ZERO);
    }

    public TaoziRedisCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {
