package com.taozi.common.system.util;
...
import com.taozi.common.util.DateUtils;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws TaoziException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws TaoziException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new TaoziException("未获取到用户");
		}
		return username;
	}
	...
	public static String getUserSystemData(String key, SysUserCacheInfo user) {
		if(user==null) {
			user = TaoziDataAutorUtils.loadUserInfo();
		}
		//#{sys_user_code}%
