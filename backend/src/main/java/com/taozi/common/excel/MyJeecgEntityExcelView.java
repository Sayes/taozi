...
@Controller("myJeecgEntityExcelView")
public class MyJeecgEntityExcelView extends JeecgEntityExcelView {
    ...
    protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // 这里加入复制表头等操作
        if (model.containsKey(ExcelInterceptor.FLAG)) {
            ExcelInterceptor excelInterceptor = (ExcelInterceptor) model.get(ExcelInterceptor.FLAG);
            excelInterceptor.doAfterExcelRendered(workbook);
        }
