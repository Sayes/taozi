...
import com.taozi.modules.demo.entity.Stats_result_hundred_1000;
import com.taozi.modules.demo.service.IStats_result_hundred_1000Service;
...
@Api(tags="百米评定明细")
@RestController
@RequestMapping("/v1/stats_result_hundred_1000")
public class Stats_result_hundred_1000Controller extends TaoziController<Stats_result_hundred_1000, IStats_result_hundred_1000Service> {
	@Autowired
	private IStats_result_hundred_1000Service stats_result_hundred_1000Service;
	 ...
	 * 分页列表查询
	 *
	 * @param stats_result_hundred_1000
	 * @param pageNo
	 * @param pageSize
	 * @param req
	 * @return
	 */
	//@AutoLog(value = "百米评定明细-分页列表查询")
	@ApiOperation(value="百米评定明细-分页列表查询", notes="百米评定明细-分页列表查询")
	@GetMapping(value = "/list")
	public Result<?> queryPageList(Stats_result_hundred_1000 stats_result_hundred_1000,
								   @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
								   @RequestParam(name="pageSize", defaultValue="20") Integer pageSize,
								   HttpServletRequest req) {
		if (!appMenu.allowAccess(req, "/stats_result_hundred_1000", "list")) {
			return Result.error(501, "没有权限");
		}
		QueryWrapper<Stats_result_hundred_1000> queryWrapper = QueryGenerator.initQueryWrapper(stats_result_hundred_1000, req.getParameterMap());
		Page<Stats_result_hundred_1000> page = new Page<Stats_result_hundred_1000>(pageNo, pageSize);
		IPage<Stats_result_hundred_1000> pageList = stats_result_hundred_1000Service.page(page, queryWrapper);
	...
	public Result<?> queryPageListMore(
		...
		if (!appMenu.allowAccess(req, "/stats_result_hundred_1000", "search")) {
			return Result.error(501, "没有权限");
		}
		StringBuffer sql = new StringBuffer();// 拼接sql
		sql.append("select * from stats_result_hundred_1000 where id > 0 ");
		...
		TaoziOneItemPage<Stats_result_hundred_1000> page = new TaoziOneItemPage<>();

		for (int i = 0; i < tableBody.size(); i++)
		{
			JSONArray row = (JSONArray) tableBody.get(i);
			Stats_result_hundred_1000 item = new Stats_result_hundred_1000();
	  ...
	  * @param maintain
	  */
	 @ApiOperation(value="百米评定明细-搜索菜单项查询", notes="百米评定明细-搜索菜单项查询")
	 ...
	 public Result<?> querySearchOpt(
		 ...
		 StringBuffer sql = new StringBuffer();// 拼接sql
		 sql.append("select p.project_id as project_id, p.project_name as project_name, r.road_code as road_code, r.maintain as maintain, r.line_dir as line_dir from stats_result_hundred_1000 as r, project as p where r.project_id = p.project_id ");
	 ...
	 * @return
	 */
	//@AutoLog(value = "百米评定明细-添加")
	@ApiOperation(value="百米评定明细-添加", notes="百米评定明细-添加")
	@PostMapping(value = "/add")
	public Result<?> add(@RequestBody Stats_result_hundred_1000 stats_result_hundred_1000, HttpServletRequest req) {
		if (!appMenu.allowAccess(req, "/stats_result_hundred_1000", "add")) {
			return Result.error(501, "没有权限");
		}
		stats_result_hundred_1000Service.save(stats_result_hundred_1000);
	 ...
	 * @return
	 */
	//@AutoLog(value = "百米评定明细-编辑")
	@ApiOperation(value="百米评定明细-编辑", notes="百米评定明细-编辑")
	@RequestMapping(value = "/edit", method = {RequestMethod.PUT,RequestMethod.POST})
	public Result<?> edit(@RequestBody Stats_result_hundred_1000 stats_result_hundred_1000, HttpServletRequest req) {
		if (!appMenu.allowAccess(req, "/stats_result_hundred_1000", "edit")) {
			return Result.error(501, "没有权限");
		}
		stats_result_hundred_1000Service.updateById(stats_result_hundred_1000);
	 ...
	 * @return
	 */
	//@AutoLog(value = "百米评定明细-通过id删除")
	@ApiOperation(value="百米评定明细-通过id删除", notes="百米评定明细-通过id删除")
	@DeleteMapping(value = "/delete")
	public Result<?> delete(@RequestParam(name="id",required=true) String id, HttpServletRequest req) {
		if (!appMenu.allowAccess(req, "/stats_result_hundred_1000", "delete")) {
			return Result.error(501, "没有权限");
		}
		stats_result_hundred_1000Service.removeById(id);
	 ...
	 * @return
	 */
	//@AutoLog(value = "百米评定明细-批量删除")
	@ApiOperation(value="百米评定明细-批量删除", notes="百米评定明细-批量删除")
	@DeleteMapping(value = "/deleteBatch")
	public Result<?> deleteBatch(@RequestParam(name="ids",required=true) String ids, HttpServletRequest req) {
		if (!appMenu.allowAccess(req, "/stats_result_hundred_1000", "deleteBatch")) {
			return Result.error(501, "没有权限");
		}
		this.stats_result_hundred_1000Service.removeByIds(Arrays.asList(ids.split(",")));
	 ...
	 * @return
	 */
	//@AutoLog(value = "百米评定明细-通过id查询")
	@ApiOperation(value="百米评定明细-通过id查询", notes="百米评定明细-通过id查询")
	@GetMapping(value = "/queryById")
	public Result<?> queryById(@RequestParam(name="id",required=true) String id, HttpServletRequest req) {
		if (!appMenu.allowAccess(req, "/stats_result_hundred_1000", "queryById")) {
			return Result.error(501, "没有权限");
		}
		Stats_result_hundred_1000 stats_result_hundred_1000 = stats_result_hundred_1000Service.getById(id);
		return Result.OK(stats_result_hundred_1000);
	}
  ...
  public ModelAndView exportXls(HttpServletRequest request, Stats_result_hundred_1000 stats_result_hundred_1000) {
	  if (!appMenu.allowAccess(request, "/stats_result_hundred_1000", "exportXls")) {
		  return null;
	  }
      return super.exportXls(request, stats_result_hundred_1000, Stats_result_hundred_1000.class, "百米评定明细");
  }
  ...
  public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
	  if (!appMenu.allowAccess(request, "/stats_result_hundred_1000", "importExcel")) {
		  return Result.error(501, "没有权限");
	  }
      return super.importExcel(request, response, Stats_result_hundred_1000.class);
  }
