...
import com.taozi.common.util.encryption.EncryptedString;
import com.taozi.modules.base.service.BaseCommonService;
// SYZ, 20220728, TODO
//import com.taozi.modules.system.entity.SysDepart;
//import com.taozi.modules.system.entity.SysTenant;
import com.taozi.modules.system.entity.SysUser;
import com.taozi.modules.system.model.SysLoginModel;
import com.taozi.modules.system.service.*;
import com.taozi.modules.system.util.RandImageUtil;
...
public class LoginController {
	...
	public Result<JSONObject> getUserInfo(HttpServletRequest request){
		...
		if(oConvertUtils.isNotEmpty(username)) {
			...
			JSONObject jsonObject=resultObj.getData();
	...
	public Result<String> sms(@RequestBody JSONObject jsonObject) {
		...
		if (object != null) {
			...
			result.setResult("验证码10分钟内，仍然有效！");
			result.setSuccess(false);
			return result;
		}
		...
		//try {
			...
			if (b == false) {
				...
				result.setResult("短信验证码发送失败,请稍后重试");
				result.setSuccess(false);
				return result;
			}
			//验证码10分钟内有效
