package com.taozi.modules.system.controller;
...
import com.taozi.common.aspect.annotation.PermissionData;
...
import com.taozi.common.util.*;
import com.taozi.modules.base.service.BaseCommonService;
import com.taozi.modules.system.entity.*;
// SYZ, 20220721, TODO
//import com.taozi.modules.system.model.DepartIdModel;
//import com.taozi.modules.system.model.SysUserSysDepartModel;
import com.taozi.modules.system.service.*;
// SYZ, 20220721, TODO
//import com.taozi.modules.system.vo.SysDepartUsersVO;
...
public class SysUserController {
	...
	public Result<IPage<SysUser>> queryPageList(SysUser user,@RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
        ...
        if(userIds!=null && userIds.size()>0){
            ...
            Map<String,String>  useDepNames = new HashMap<String, String>();
    ...
    public Result<List<DepartIdModel>> getUserDepartsList(@RequestParam(name = "userId", required = true) String userId) {
        ...
        try {
            ...
            result.setResult("查找过程中出现了异常: " + e.getMessage());
            return result;
        }
    ...
    */
	...
	public Result<JSONObject> userRegister(@RequestBody JSONObject jsonObject, SysUser user) {
        ...
        if(null == code){
            ...
            result.setResult("手机验证码失效，请重新获取");
            result.setSuccess(false);
            return result;
        }
